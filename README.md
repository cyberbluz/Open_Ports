...
## In the second phase of the project,  I accessed both Network Security Groups and created a new rule opening both VMs to all Inbound Internet Traffic: <br>(⚠️Danger_AllowAnyCustomInboundTraffic)  
